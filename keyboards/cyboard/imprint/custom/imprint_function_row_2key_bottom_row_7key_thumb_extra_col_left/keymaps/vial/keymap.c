...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_fun_custom(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  _______,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                          KC_LGUI, KC_LALT, KC_ENT,  KC_DEL,  KC_ESC,           KC_GRAVE, KC_BSPC, KC_SPC,  KC_LBRC, KC_RBRC,
                                   KC_LGUI, KC_HOME, KC_END, _______,           _______,  KC_CAPS, KC_APP,  MO(1)
    ),
    ...
    [1] = LAYOUT_fun_custom(
        ...
        _______, _______, _______, _______, _______, _______, _______,                  _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
