...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_fun_custom(
        TG(_GAMING_OTHER), KC_F1,                    KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,                                     KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,                     KC_F11,
    ...
    [_NUMBERS] = LAYOUT_fun_custom(
        _______, _______, _______, _______, _______, _______, _______,                           _______, _______, _______, _______, _______, _______,
        _______, KC_NUM,  KC_PEQL, KC_PAST, KC_PSLS, KC_NO,   KC_NO,                             KC_NUM,  KC_PSLS, KC_PAST, KC_PEQL, KC_NO,   _______,
        _______, KC_PMNS, KC_P7,   KC_P8,   KC_P9,   KC_NO,   KC_NO,                             KC_NO,   KC_P7,   KC_P8,   KC_P9,   KC_PMNS, _______,
        _______, KC_PPLS, KC_P4,   KC_P5,   KC_P6,   KC_P0,   KC_NO,                             KC_P0,   KC_P4,   KC_P5,   KC_P6,   KC_PPLS, _______,
        _______, KC_LCTL, KC_P1,   KC_P2,   KC_P3,   KC_PDOT,                                   KC_PDOT, KC_P1,   KC_P2,   KC_P3,   KC_LCTL, _______,
    ...
    [_GAMING_OTHER] = LAYOUT_fun_custom(
        ...
        _______,  _______, _______, _______, _______, _______,                                    _______, _______, _______, _______, _______,  _______,
                                ...
                                _______, _______,    LCTL(KC_LSFT), KC_SPC, LSFT(KC_DEL),    _______, _______, _______,    _______, _______,
